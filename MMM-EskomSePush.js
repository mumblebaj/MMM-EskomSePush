Module.register("MMM-EskomSePush", {
  ...
  getDom: function () {
    ...
    for (let i = 0; i <= 23; i++) {
      ...
      const colHour = createDivWithClass(`column col${hour}00 ${i}`);
      colHour.classList.add("gray");
      esp_columns.appendChild(colHour);

      // Create columns for 30-minute intervals if not midnight
      if (i !== 23) {
        const colHalfHour = createDivWithClass(`column col${hour}30 ${i}30`);
    ...
    const col2330 = createDivWithClass("column col2330 2330");
  ...
  updateESP: function (espData) {
    ...
    espData[0]?.events.forEach((event) => {
      if (event.relDate === "today" && event.startTime === "0:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "2:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "4:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "6:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "8:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "10:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "12:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "14:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "16:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "18:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "20:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "today" && event.startTime === "22:0" && event.duration == 2.5) {
      ...
      if (event.relDate === "tomorrow" && event.startTime === "0:0" && event.duration == 2.5) {
        this.updateShow("tcol24");
        this.updateColor("col0000");
        this.updateColor("col0030");
        this.updateColor("col0100");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "2:0" && event.duration == 2.5) {
        this.updateShow("tcol02");
        this.updateColor("col0200");
        this.updateColor("col0230");
        this.updateColor("col0300");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "4:0" && event.duration == 2.5) {
        this.updateShow("tcol04");
        this.updateColor("col0400");
        this.updateColor("col0430");
        this.updateColor("col0500");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "6:0" && event.duration == 2.5) {
        this.updateShow("tcol06");
        this.updateColor("col0600");
        this.updateColor("col0630");
        this.updateColor("col0700");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "8:0" && event.duration == 2.5) {
        this.updateShow("tcol08");
        this.updateColor("col0800");
        this.updateColor("col0830");
        this.updateColor("col0900");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "10:0" && event.duration == 2.5) {
        this.updateShow("tcol10");
        this.updateColor("col1000");
        this.updateColor("col1030");
        this.updateColor("col1100");
      ...
      if (event.relDate === "today" && event.startTime === "0:0" && event.duration == 4.5) {
        this.updateShow("tcol24");
      ...
      if (event.relDate === "today" && event.startTime === "2:0" && event.duration == 4.5) {
        this.updateShow("tcol02");
        if (hours == 2 || hours == 3 || hours == 4 || hours == 5 || hours == 6) {
          this.updateShedding("col0200");
          this.updateShedding("col0230");
          this.updateShedding("col0300");
          this.updateShedding("col0330");
      ...
      if (event.relDate === "today" && event.startTime === "4:0" && event.duration == 4.5) {
        this.updateShow("tcol04");
      ...
      if (event.relDate === "today" && event.startTime === "6:0" && event.duration == 4.5) {
        this.updateShow("tcol06");
        if (hours == 6 || hours == 7 || hours == 8 || hours == 9 || hours == 10) {
          this.updateShedding("col0600");
          this.updateShedding("col0630");
          this.updateShedding("col0700");
          this.updateShedding("col0730");
      ...
      if (event.relDate === "today" && event.startTime === "8:0" && event.duration == 4.5) {
        this.updateShow("tcol08");
        if (hours == 8 || hours == 9 || hours == 10 || hours == 11 || hours == 12) {
          this.updateShedding("col0800");
          this.updateShedding("col0830");
          this.updateShedding("col0900");
          this.updateShedding("col0930");
      ...
      if (event.relDate === "today" && event.startTime === "10:0" && event.duration == 4.5) {
        this.updateShow("tcol10");
      ...
      if (event.relDate === "today" && event.startTime === "12:0" && event.duration == 4.5) {
        this.updateShow("tcol12");
        if (hours == 12 || hours == 13 || hours == 14 || hours == 15 || hours == 16) {
          this.updateShedding("col1200");
          this.updateShedding("col1230");
          this.updateShedding("col1300");
          this.updateShedding("col1330");
      ...
      if (event.relDate === "today" && event.startTime === "14:0" && event.duration == 4.5) {
        this.updateShow("tcol14");
        if (hours == 14 || hours == 15 || hours == 16 || hours == 17 || hours == 18) {
          this.updateShedding("col1400");
          this.updateShedding("col1430");
          this.updateShedding("col1500");
          this.updateShedding("col1530");
      ...
      if (event.relDate === "today" && event.startTime === "16:0" && event.duration == 4.5) {
        this.updateShow("tcol16");
        if (hours == 16 || hours == 17 || hours == 18 || hours == 19 || hours == 20) {
          this.updateShedding("col1600");
          this.updateShedding("col1630");
          this.updateShedding("col1700");
          this.updateShedding("col1730");
      ...
      if (event.relDate === "today" && event.startTime === "18:0" && event.duration == 4.5) {
        this.updateShow("tcol18");
      ...
      if (event.relDate === "today" && event.startTime === "20:0" && event.duration == 4.5) {
        this.updateShow("tcol20");
        if (hours == 20 || hours == 21 || hours == 22 || hours == 23 || hours == 0) {
          this.updateShedding("col2000");
          this.updateShedding("col2030");
          this.updateShedding("col2100");
          this.updateShedding("col2130");
      ...
      if (event.relDate === "today" && event.startTime === "22:0" && event.duration == 4.5) {
        this.updateShow("tcol22");
        if (hours == 22 || hours == 23 || hours == 0 || hours == 1 || hours == 2) {
          this.updateShedding("col2200");
          this.updateShedding("col2230");
          this.updateShedding("col2300");
          this.updateShedding("col2330");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "0:0" && event.duration == 4.5) {
        this.updateShow("tcol24");
        this.updateColor("col0000");
        this.updateColor("col0030");
        this.updateColor("col0100");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "2:0" && event.duration == 4.5) {
        this.updateShow("tcol02");
        this.updateColor("col0200");
        this.updateColor("col0230");
        this.updateColor("col0300");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "4:0" && event.duration == 4.5) {
        this.updateShow("tcol04");
        this.updateColor("col0400");
        this.updateColor("col0430");
        this.updateColor("col0500");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "6:0" && event.duration == 4.5) {
        this.updateShow("tcol06");
        this.updateColor("col0600");
        this.updateColor("col0630");
        this.updateColor("col0700");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "8:0" && event.duration == 4.5) {
        this.updateShow("tcol08");
        this.updateColor("col0800");
        this.updateColor("col0830");
        this.updateColor("col0900");
      ...
      if (event.relDate === "tomorrow" && event.startTime === "10:0" && event.duration == 4.5) {
        this.updateShow("tcol10");
        this.updateColor("col1000");
        this.updateColor("col1030");
        this.updateColor("col1100");
